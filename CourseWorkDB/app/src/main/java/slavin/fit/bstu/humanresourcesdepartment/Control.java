...
public class Control extends AppCompatActivity {
    ...
    Button register, back, change, delete;
    EditText id, login, password, name, surname, position;
            ...
            compositeDisposable.add(IMyAPI.registerUser(user)
                    ...
                    .subscribe(new Consumer<String>() {
                        ...
                        public void accept(Throwable throwable) throws Exception {
                            Toast.makeText(Control.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }));
        }
    ...
    public void change(){
        ...
        compositeDisposable.add(IMyAPI.deleteUser(user)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Consumer<String>() {
                    @Override
        ...
        db.delete(DatabaseHelper.TABLE_WORKERS, DatabaseHelper.COLUMN_WORKERS_ID + " = " + id.getText().toString(), null);
        ...
        Toast toast = Toast.makeText(this, "Данные обновлены", Toast.LENGTH_SHORT);
        toast.show();
    ...
    public void delete(){
        ...
        db.delete(DatabaseHelper.TABLE_WORKERS, DatabaseHelper.COLUMN_WORKERS_ID + " = " + id.getText().toString(), null);
        Toast toast = Toast.makeText(this, "Сотрудник уволен", Toast.LENGTH_SHORT);
        toast.show();
